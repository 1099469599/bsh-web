...
<head>
	...
	<script type="text/javascript">
					...
					$("#scheduleForm").form('submit',{
						...
						success:function(data) {
							...
							if(statusCode == 'success') {         //保存成功时
								$('#scheduleDg').datagrid({url:'schedule/datagrid'});
							}
						}
					});
				}
		...
		function saveAdd() {
			...
			$("#scheduleForm").form("submit",{
				url:'schedule/add?maxTimeItem=' + currMaxTimeItem,
				onSubmit:function() {
		...
		function saveEdit() {
			...
			$("#scheduleForm").form("submit",{
				url:'schedule/update?maxTimeItem=' + currMaxTimeItem,
				onSubmit:function() {
					return $(this).form('validate');
				},
				success:function (data) {
		...
		<table id="scheduleDg">
			<thead>
				...
				<tr style="height:12px;">		
					<th data-options="field:'SCHEDULE_NAME',width:250,align:'center'">调度名称</th>
					...
					<th data-options="field:'DATETYPE_DETAIL_DESC',width:400,align:'center'">日期类型</th>
