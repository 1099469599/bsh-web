...
public class BSHOrderList extends Model<BSHOrderList> {
	 ...
	 * @return
	 */
	public boolean updateBSHOrderListRespondAndBillsec(String id,String respond,int billsec,String keyValue) {
		
		boolean  b = false;
		
		String sql = "update bsh_orderlist set RESPOND=?,STATE=2,BILLSEC=?,VAR1=? where ID=?";
		
		int count = Db.update(sql, respond,billsec,keyValue,id);
