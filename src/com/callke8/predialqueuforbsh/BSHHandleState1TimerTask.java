...
public class BSHHandleState1TimerTask extends TimerTask {
	...
	public void run() {
		...
		List<Record> list = BSHOrderList.dao.getBSHOrderListByCondition(null, null, null, null, null, null,null,null,"1", null, null, null,null,null, befault5MinuteDateTime);
